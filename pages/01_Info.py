...
<a href='Main' target='_self'>
  <button id="myButton" style="background-color: #0074CC; color: white; padding: 10px 20px; border: none; border-radius: 12px; cursor: pointer; width: 30%;">Detect Disease</button>
</a>
"""
